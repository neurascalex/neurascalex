...
const Home: React.FC = () => {
  ...
  return (
    <div className="animate-in fade-in duration-1000 bg-warm-white min-h-screen">
      ...
      {/* Trusted by Leading UK Health Educators - Enhanced */}
      <section className="py-24 bg-white border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <h2 className="text-4xl lg:text-5xl serif text-navy-900 text-center mb-20 tracking-tight">Trusted by Leading UK Health Educators</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Dr. Deepak */}
            <div className="p-10 border border-gray-100 rounded-sm hover:shadow-2xl transition-all duration-300 flex flex-col bg-white group">
               <div className="flex items-start mb-8">
                 {/* Placeholder Avatar - Circular */}
                 <div className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center text-gray-500 font-bold text-xl mr-5 flex-shrink-0">
                    DR
                 </div>
                 <div className="mt-1">
                   <h3 className="text-lg font-serif font-bold text-navy-900">Dr. Deepak Ravindran</h3>
                   <p className="text-[9px] text-teal-800 font-bold uppercase tracking-widest mt-2 leading-relaxed">Pain Management Consultant • <br/>Chief Medical Advisor</p>
                 </div>
               </div>
               <p className="text-gray-600 italic text-sm leading-relaxed mb-8 flex-grow font-light">
                 "I've reclaimed 20% of my weekly capacity. My Digital Twin handles triage using my 'Hurting to Healing' framework—safely and in my voice. It's like having my best associate working 24/7."
               </p>
               <div className="mt-auto">
                 <p className="text-[9px] text-gray-400 mb-6 uppercase tracking-widest">MBBS, MD, FRCA, FFPMRCA, EDPM</p>
                 <Link to="/demo" className="text-teal-800 text-xs font-bold hover:text-navy-900 transition-colors flex items-center uppercase tracking-widest group-hover:translate-x-1 duration-300">
                   → See Dr. Deepak's Twin in action
                 </Link>
               </div>
            </div>
            ...
            <div className="p-10 border border-gray-100 rounded-sm hover:shadow-2xl transition-all duration-300 flex flex-col bg-white group">
               <div className="flex items-start mb-8">
                 ...
                 <div className="mt-1">
                   <h3 className="text-lg font-serif font-bold text-navy-900">Dr. Abrar Hussein</h3>
                   <p className="text-[9px] text-teal-800 font-bold uppercase tracking-widest mt-2 leading-relaxed">Consultant Psychiatrist • <br/>Alpha Member</p>
                 </div>
               </div>
               <p className="text-gray-600 italic text-sm leading-relaxed mb-8 flex-grow font-light">
                 "Automating ADHD referral triage has transformed my practice. Complex cases now reach me pre-qualified and ready. My patients get instant answers to their orientation questions at 2 AM."
               </p>
               <div className="mt-auto">
                 <Link to="/demo" className="text-teal-800 text-xs font-bold hover:text-navy-900 transition-colors flex items-center uppercase tracking-widest group-hover:translate-x-1 duration-300">
                   → Explore Dr. Abrar's approach
                 </Link>
               </div>
            </div>
            ...
            <div className="p-10 border border-gray-100 rounded-sm hover:shadow-2xl transition-all duration-300 flex flex-col bg-white group">
               <div className="flex items-start mb-8">
                 ...
                 <div className="mt-1">
                   <h3 className="text-lg font-serif font-bold text-navy-900">Dr. Arokia Rajkumar</h3>
                   <p className="text-[9px] text-teal-800 font-bold uppercase tracking-widest mt-2 leading-relaxed">Consultant Psychiatrist • <br/>Alpha Member</p>
                 </div>
               </div>
               <p className="text-gray-600 italic text-sm leading-relaxed mb-8 flex-grow font-light">
                 "My patients understand their care better before they even book. The Digital Twin empowers them to own their voice and arrive prepared for meaningful clinical conversations."
               </p>
               <div className="mt-auto">
                 <Link to="/demo" className="text-teal-800 text-xs font-bold hover:text-navy-900 transition-colors flex items-center uppercase tracking-widest group-hover:translate-x-1 duration-300">
                   → See the system live
